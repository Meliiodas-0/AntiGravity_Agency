export const content = {
  ...
  // Keep removed clients saved in case we want to add them back later
  savedProofStrips: [
    ...
    { name: "Uttam Dairy", url: "https://www.supremeagro.com/", logo: "/logos/uttam-dairy.png" },
    ...
    { name: "Organic Zing", url: "https://organiczing.co", logo: "/logos/organic-zing.png?v=3" },
    { name: "Littloo", url: "https://littloo.in", logo: "/logos/littloo.png?v=3" },
    { name: "Taabi", url: "https://taabi.ai/", logo: "/logos/taabi.webp?v=3" },
    { name: "Shop Rhythm", url: "https://www.shoprythm.com", logo: "/logos/shop-rhythm.png?v=3" },
  ],
  objectives: {
