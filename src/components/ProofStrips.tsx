    ...
    <div className="overflow-hidden marquee-fade-mask py-2 sm:py-3 w-full">
      <div
        className={`flex gap-3 sm:gap-6 md:gap-8 whitespace-nowrap ${
          reverse ? "marquee-strip-reverse" : "marquee-strip"
        }`}
      ...
      >
        {repeated.map((item, i) => (
          <a
            ...
            className="flex flex-col items-center justify-center border border-border/40 rounded-xl px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 hover:border-primary/50 transition-colors duration-200 min-w-[120px] sm:min-w-[150px] md:min-w-[170px]"
          >
...
export default function ProofStrips() {
  return (
    <section id="proof" className="relative scroll-mt-24 py-20 sm:py-24 md:py-32">
      ...
      <ScrollReveal className="max-w-6xl mx-auto px-5 sm:px-6 mb-12 sm:mb-16">
