      ...
      >
        {repeated.map((item, i) => (
          <a
            ...
            className="group relative flex items-center justify-center rounded-2xl px-8 sm:px-12 py-8 sm:py-10 min-w-[200px] sm:min-w-[280px] md:min-w-[320px] bg-white/[0.02] border border-white/5 backdrop-blur-sm transition-all duration-700 hover:bg-white/[0.05] hover:border-white/20 hover:shadow-2xl hover:shadow-primary/10"
          >
            ...
            <div className="relative w-36 h-14 sm:w-48 sm:h-20 md:w-64 md:h-24 flex items-center justify-center transition-all duration-700 group-hover:scale-105 group-hover:brightness-110">
              <img
                src={item.logo}
                alt={item.name}
                title={item.name}
