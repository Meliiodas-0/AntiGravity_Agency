  ...
  return (
    <section id="hero" ref={ref} className="relative min-h-[90vh] sm:min-h-screen flex flex-col items-center justify-center px-5 sm:px-6 pt-14">
      ...
      <div className="absolute inset-0 -bottom-32 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-primary/3 blur-[100px]" />
        <div
      ...
      <motion.div className="relative max-w-4xl text-center" style={{ opacity }}>
        <motion.p
        ...
        <motion.a
          ...
          style={{ y: ctaY }}
          href="#contact"
          className="inline-block bg-primary text-primary-foreground font-semibold px-10 sm:px-12 py-4 sm:py-5 rounded-lg hover:brightness-110 active:scale-[0.97] transition-all text-base sm:text-lg shadow-lg shadow-primary/20"
        >
          {content.hero.cta}
        </motion.a>
      </motion.div>
