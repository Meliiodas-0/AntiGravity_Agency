        ...
        >
            <div className="max-w-7xl mx-auto px-5 sm:px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    {/* Animated DNA Side */}
                    <div className="flex-1 relative h-[400px] sm:h-[500px] w-full max-w-[500px] flex items-center justify-center">
                        {/* Phone Icon */}
                        <motion.div
                            style={{ y: smoothY }}
                        ...
                        >
                            ...
                            {/* Inner screen content approximation */}
                                ...
                                return (
                                    <motion.div
                                        ...
                                        style={{
                                            ...
                                            zIndex: useTransform(smoothRotation, (r) => Math.cos(angle + (r * Math.PI) / 180) > 0 ? 30 : 10),
